...
class AddRoutine2 extends StatefulWidget {
  ...
  @override
  State<AddRoutine2> createState() => _AddRoutine2State();
}

class _AddRoutine2State extends State<AddRoutine2> {
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if ((_formKey.currentState?.validate() ?? false) &&
                      ...
                      databaseService.addRoutine(titleController.text,
